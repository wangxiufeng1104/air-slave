...
void MX_TIM1_Init(void)
{
  ...
  htim1.Instance = ((TIM_TypeDef *)((0x40000000U + 0x00010000U) + 0x00002C00U));
  htim1.Init.Prescaler = 64-1;
  htim1.Init.CounterMode = 0x00000000U;
  htim1.Init.Period = 10000-1;
  htim1.Init.ClockDivision = 0x00000000U;
  htim1.Init.RepetitionCounter = 0;
  htim1.Init.AutoReloadPreload = 0x0000U;
  if (HAL_TIM_Base_Init(&htim1) != HAL_OK)
  {
    _Error_Handler("../Src/tim.c", 66);
  }

  sClockSourceConfig.ClockSource = ((0x1U << (12U)));
  if (HAL_TIM_ConfigClockSource(&htim1, &sClockSourceConfig) != HAL_OK)
  {
    _Error_Handler("../Src/tim.c", 72);
  }
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  if(tim_baseHandle->Instance==((TIM_TypeDef *)((0x40000000U + 0x00010000U) + 0x00002C00U)))
  {
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* tim_pwmHandle)
{
  ...
  if(tim_pwmHandle->Instance==((TIM_TypeDef *)(0x40000000U + 0x00000000U)))
  {
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  if(timHandle->Instance==((TIM_TypeDef *)(0x40000000U + 0x00000000U)))
  {
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  if(tim_baseHandle->Instance==((TIM_TypeDef *)((0x40000000U + 0x00010000U) + 0x00002C00U)))
  {
    ...
    (((RCC_TypeDef *)((0x40000000U + 0x00020000U) + 0x00001000U))->APB2ENR &= ~((0x1U << (11U))));
