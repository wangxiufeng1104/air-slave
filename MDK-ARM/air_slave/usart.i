...
void MX_USART1_UART_Init(void)
{
  ...
  huart1.Instance = ((USART_TypeDef *)((0x40000000U + 0x00010000U) + 0x00003800U));
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *)((0x40000000U + 0x00010000U) + 0x00003800U)))
  {
   

   
     
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *)((0x40000000U + 0x00020000U) + 0x00001000U))->APB2ENR) |= ((0x1U << (14U)))); tmpreg = ((((RCC_TypeDef *)((0x40000000U + 0x00020000U) + 0x00001000U))->APB2ENR) & ((0x1U << (14U)))); (void)tmpreg; } while(0U);
    ...
    hdma_usart1_tx.Instance = ((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000044U));
    ...
    hdma_usart1_tx.Init.Priority = ((uint32_t)(0x2U << (12U)));
    if (HAL_DMA_Init(&hdma_usart1_tx) != HAL_OK)
    {
      _Error_Handler("../Src/usart.c", 141);
    }

    do{ (uartHandle)->hdmatx = &(hdma_usart1_tx); (hdma_usart1_tx). Parent = (uartHandle); } while(0U);

     
    hdma_usart1_rx.Instance = ((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000058U));
    hdma_usart1_rx.Init.Direction = 0x00000000U;
    hdma_usart1_rx.Init.PeriphInc = 0x00000000U;
    hdma_usart1_rx.Init.MemInc = ((uint32_t)(0x1U << (7U)));
    ...
    hdma_usart1_rx.Init.Priority = ((uint32_t)(0x3U << (12U)));
    if (HAL_DMA_Init(&hdma_usart1_rx) != HAL_OK)
    {
      _Error_Handler("../Src/usart.c", 157);
    }
  ...
  else if(uartHandle->Instance==((USART_TypeDef *)(0x40000000U + 0x00004800U)))
  {
    ...
    hdma_usart3_rx.Init.Priority = ((uint32_t)(0x2U << (12U)));
    if (HAL_DMA_Init(&hdma_usart3_rx) != HAL_OK)
    {
      _Error_Handler("../Src/usart.c", 203);
    }
    ...
    hdma_usart3_tx.Init.Priority = ((uint32_t)(0x1U << (12U)));
    if (HAL_DMA_Init(&hdma_usart3_tx) != HAL_OK)
    {
      _Error_Handler("../Src/usart.c", 219);
    }
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *)((0x40000000U + 0x00010000U) + 0x00003800U)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000800U)), ((uint16_t)0x0200)|((uint16_t)0x0400));
...
void _dbg_printf(const char *format,...)
{
	uint32_t length;
	va_list args;
	while(UsartType1.dmaSend_flag == 1) HAL_Delay(1);
...
void InsCopy(uint8_t *pSrc,uint8_t *pDes,uint8_t Len)
{
	...
	Last_Size = ((uint32_t)&ins_struct.ins_Buf[30 - 1] - (uint32_t)ins_struct.insp_end) + 1;
	if(Last_Size >= Len)  
	{
		memcpy(pDes,pSrc,Len);
		ins_struct.insp_end = ins_struct.insp_end + Len;
		if(ins_struct.insp_end > &ins_struct.ins_Buf[30 - 1])
		{
	...
	{
		L_end = Last_Size;         
		L_start = Len - Last_Size; 
		


			memcpy(pDes,pSrc,L_end);
			memcpy(ins_struct.ins_Buf,pSrc+L_end,L_start);
			ins_struct.insp_end = &ins_struct.ins_Buf[L_start - 1] + 1;
			ins_struct.ins_length += Len;
...
void UsartReceive_IDLE(UART_HandleTypeDef *huart)
{
	...
	if(((((huart)->Instance ->SR & (((uint32_t)(0x1U << (4U))))) == (((uint32_t)(0x1U << (4U))))) != RESET))
	{ 
		do{ volatile uint32_t tmpreg = 0x00U; tmpreg = (&huart1)->Instance ->SR; tmpreg = (&huart1)->Instance ->DR; (void)tmpreg; } while(0U);
		HAL_UART_DMAStop(&huart1);
		temp = huart1.hdmarx->Instance->CNDTR;
		UsartType1.rx_len =  1024 - temp; 
		if(UsartType1.rx_len == 0x400) UsartType1.rx_len = 0;
		UsartType1.receive_flag=1;   
		HAL_UART_Receive_DMA(&huart1,UsartType1.usartDMA_rxBuf,1024);	
...
void Usart3Receive_IDLE(UART_HandleTypeDef *huart)
{
	...
	{ 
		...
		UsartType3.rx_len =  1024 - temp; 
		if(UsartType3.rx_len == 0x400) UsartType1.rx_len = 0;
		UsartType3.receive_flag=1;   
		HAL_UART_Receive_DMA(&huart3,UsartType3.usartDMA_rxBuf,1024);	
...
void HAL_UART_TxCpltCallback(UART_HandleTypeDef *huart)
{
	...
	{
		((((huart->hdmatx)->Instance ->CCR) &= ~((0x1U << (0U)))));
...
{
	while(UsartType1.dmaSend_flag == 1) HAL_Delay(1);
	UsartType1.dmaSend_flag = 1;
	((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000800U))->BSRR = ((uint16_t)0x0100);
	HAL_UART_Transmit_DMA(&huart1, pData, Size);
}
void SendDataUSART3_DMA(uint8_t *pData, uint16_t Size)
{
	while(UsartType3.dmaSend_flag == 1) HAL_Delay(1);
	UsartType3.dmaSend_flag = 1;
	((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U))->BSRR = ((uint16_t)0x0004);
