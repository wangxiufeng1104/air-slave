...
#line 41 "../Src/stm32f1xx_hal_msp.c"
...
void HAL_MspInit(void)
{
  ...
  do{ uint32_t tmpreg = ((AFIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000000U))->MAPR; tmpreg &= ~(0x7U << (24U)); tmpreg |= (0x1U << (25U)); ((AFIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000000U))->MAPR = tmpreg; }while(0U);
