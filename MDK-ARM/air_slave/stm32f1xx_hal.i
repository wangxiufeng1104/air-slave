...
#line 53 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal.c"
...
#line 82 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal.c"
...
uint32_t HAL_GetHalVersion(void)
{
  return (((0x01U) << 24) |((0x01U) << 16) |((0x02U) << 8 ) |((0x00U)));
}
